...
const Home = () => {
  ...
  return (
    <>
      <AnimatedCopy>
        ...
        >
          <div className='flex flex-col h-full space-y-4 lg:text-center lg:items-center'>
            ...
            <h2 className='spilt-text h2 text-balance'>
      ...
      <section
        id='mission'
        className='container gradient rounded-lg overflow-hidden lg:h-screen p-4 lg:p-0'
      >
        <div className='grid lg:grid-cols-12 h-full'>
          <div className='lg:col-span-7 flex flex-col items-center justify-center space-y-4'>
            ...
            <h2 className='flex items-center gap-4'>
              <span className='text-7xl lg:text-[12rem] font-semibold'>4382</span>
              <span className='text-2xl font-semibold'>Tree Planted</span>
            </h2>
            <Button
              variant='secondary'
              className='w-full max-w-sm inline-flex gap-3 items-center mt-4'
            >
              See your Forest
              <RiTreeFill />
            </Button>
